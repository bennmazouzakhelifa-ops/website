...
Also, since there is no login/password needed, there will be no Secret Token on the Tools page for the [Passwordless API](/docs/guide/advanced/passwordless-api).
...
- read the page about [Public Shortening](/docs/guide/advanced/public-shortening) for important tips and advices.
